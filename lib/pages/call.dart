  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        child:UtenteChiamante(),
        ),
            Container( //Container chat
              margin:  EdgeInsets.only(left:RicalcoloWidth(20.0, context),top:RicalcoloHeight(518.0, context)),
              height: 200,
      ...
      Container(
        margin:  EdgeInsets.only(left:RicalcoloWidth(1.0, context),top:RicalcoloHeight(650.0, context)),
        child: BottoniSup(),
      ),
  ...
  Widget BottoniSup(){ //lancia offerta riepilogo offerte e gira telecamera
    return Row(
      children: <Widget>[
        ...
        Container( //Bottone lancia offerta
    ...
    height:RicalcoloHeight(35.0, context),
          ...
          child:Container(
    margin:  EdgeInsets.only(left:RicalcoloWidth(1.0, context),top:RicalcoloHeight(8.0, context)),
    child:Text(
            'LANCIA OFFERTA!',
            style: TextStyle(
